...
public class MonteCarloTest {
	...
	static NumberFormat fTimeFormat = new DecimalFormat("00000000.000");
	static NumberFormat longitudeFormat = new DecimalFormat("0.000000000000");
	static NumberFormat latitudeFormat = new DecimalFormat("0.000000000000");
//	static NumberFormat longitudeFormat = new DecimalFormat("0.000000000000e;-0.000000000000w");
//	static NumberFormat latitudeFormat = new DecimalFormat("0.000000000000n;-0.000000000000s");
			...
			double azRange, double elRange)
	{
		...
		for( Target target : targets ) {
			for( int trial=0; trial<trialsPerTarget; trial++ ) {
				...
				// TODO just generate pedestal measurements in the same order they appear in the pedestal file.
...
//				} // or they could be specified by a pedestal file...
				...
				for( Pedestal pedestal : pedestals ) {
					...
					pedestal.pointDirection(azimuth, elevation);
...
//					double range = Double.parseDouble( cols[3+n].trim() ); // TODO number of sensor will have to come from the pedestal file as well...
					pedestal.pointDirection(/*range,*/ azimuth, elevation);
				}
